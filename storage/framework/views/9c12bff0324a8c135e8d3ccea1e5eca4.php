...
unset($__errorArgs, $__bag); ?>" id="floatingSelect"
                            ...
                            <option value="ข้อเสนอแนะ" <?php echo e(old('papade') == 'ข้อเสนอแนะ' ? 'selected' : ''); ?>>
                                ข้อเสนอแนะ</option>
                            <option value="ข้อชื่นชม" <?php echo e(old('papade') == 'ข้อชื่นชม' ? 'selected' : ''); ?>>ข้อชื่นชม
                            </option>
                            <option value="อื่นๆ" <?php echo e(old('papade') == 'อื่นๆ' ? 'selected' : ''); ?>>อื่นๆ</option>
                        </select>
...
unset($__errorArgs, $__bag); ?>" id="floatingSelect"
                            ...
                            <option value="ระบบบริการ" <?php echo e(old('type') == 'ระบบบริการ' ? 'selected' : ''); ?>>ระบบบริการ
                            </option>
                            ...
                            <option value="สิ่งแวดล้อม" <?php echo e(old('type') == 'สิ่งแวดล้อม' ? 'selected' : ''); ?>>
                                สิ่งแวดล้อม</option>
                            <option value="อื่นๆ" <?php echo e(old('type') == 'อื่นๆ' ? 'selected' : ''); ?>>อื่นๆ</option>
                        </select>
...
<?php /**PATH /var/www/html/report/resources/views/livewire/report.blade.php ENDPATH**/ ?>